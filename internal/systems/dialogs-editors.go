...
func CustomizeEditorDialog(key string) {
	...
	case constants.DialogBossSettings:
		customizeBossSettings()
...
func editorPanels() {
	...
	setCanvasShaderColorsDefault(editorPanelLeft.ViewPort.Canvas)
	...
	setCanvasShaderColorsDefault(editorPanelTop.ViewPort.Canvas)
	...
	setCanvasShaderColorsDefault(blockSelect.ViewPort.Canvas)
