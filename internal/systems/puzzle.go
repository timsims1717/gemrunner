...
func UpdatePuzzleShaders() {
	...
	data.PuzzleView.Canvas.SetUniform("uRedGoop", float32(data.CurrPuzzleSet.CurrPuzzle.Metadata.GoopColor.R))
	data.PuzzleView.Canvas.SetUniform("uGreenGoop", float32(data.CurrPuzzleSet.CurrPuzzle.Metadata.GoopColor.G))
	data.PuzzleView.Canvas.SetUniform("uBlueGoop", float32(data.CurrPuzzleSet.CurrPuzzle.Metadata.GoopColor.B))
