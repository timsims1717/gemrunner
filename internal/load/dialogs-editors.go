...
func EditorDialogs(win *pixelgl.Window) {
	ui.NewDialog(openPuzzleConstructor)
	ui.NewDialog(changeNameConstructor)
	ui.NewDialog(noPlayersInPuzzleConstructor)
	ui.NewDialog(areYouSureDeleteConstructor)
	ui.NewDialog(unableToSaveConstructor)
	ui.NewDialog(unableToSaveConfirmConstructor)
	ui.NewDialog(worldDialogConstructor)
	ui.NewDialog(crackedTileOptionsConstructor)
	ui.NewDialog(bombOptionsConstructor)
	ui.NewDialog(jetpackOptionsConstructor)
	editorPanels()
	ui.NewDialog(editorOptBottomConstructor)
	ui.NewDialog(editorOptRightConstructor)
				...
				case "world_list":
					for i := 0; i < constants.WorldCustom; i++ {
						...
						lti := ui.ElementConstructor{
							...
							Batch:       ladderTileItem.Batch,
							Position:    ladderTileItem.Position,
							ElementType: ladderTileItem.ElementType,
						}
						...
						dti := ui.ElementConstructor{
							...
							Batch:       doodadTileItem.Batch,
							Position:    doodadTileItem.Position,
							ElementType: doodadTileItem.ElementType,
						}
						...
						wti := ui.ElementConstructor{
							...
							ElementType: worldTxtItem.ElementType,
						}
...
func editorPanels() {
	ui.NewDialog(editorPanelTopConstructor)
	ui.NewDialog(editorPanelLeftConstructor)
