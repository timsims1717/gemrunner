...
var (
	P1Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"lift":      pxginput.New(pixelgl.KeyKP3, pixelgl.ButtonY),
	...
	P2Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"lift":   pxginput.New(pixelgl.KeyC, pixelgl.ButtonY),
	...
	P3Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"lift":   pxginput.New(pixelgl.KeyM, pixelgl.ButtonY),
	...
	P4Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"lift":   pxginput.New(pixelgl.KeySlash, pixelgl.ButtonY),
