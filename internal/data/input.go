...
var (
	P1Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"digLeft":   pxginput.NewJoyless(pixelgl.KeyKP7).AddAxis(pixelgl.AxisLeftTrigger),
			"digRight":  pxginput.NewJoyless(pixelgl.KeyKP9).AddAxis(pixelgl.AxisRightTrigger),
			"kill":      pxginput.New(pixelgl.KeyKPSubtract, pixelgl.ButtonBack),
	...
	P2Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"digLeft":  pxginput.NewJoyless(pixelgl.KeyQ).AddAxis(pixelgl.AxisLeftTrigger),
			"digRight": pxginput.NewJoyless(pixelgl.KeyE).AddAxis(pixelgl.AxisRightTrigger),
			"kill":     pxginput.New(pixelgl.KeyGraveAccent, pixelgl.ButtonBack),
		},
		Mode: pxginput.Any,
	}
	P3Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"digLeft":  pxginput.NewJoyless(pixelgl.KeyT).AddAxis(pixelgl.AxisLeftTrigger),
			"digRight": pxginput.NewJoyless(pixelgl.KeyU).AddAxis(pixelgl.AxisRightTrigger),
			"kill":     pxginput.New(pixelgl.Key8, pixelgl.ButtonBack),
		},
		Mode: pxginput.Any,
	}
	P4Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"digLeft":  pxginput.NewJoyless(pixelgl.KeyO).AddAxis(pixelgl.AxisLeftTrigger),
			"digRight": pxginput.NewJoyless(pixelgl.KeyLeftBracket).AddAxis(pixelgl.AxisRightTrigger),
			"kill":     pxginput.New(pixelgl.KeyBackspace, pixelgl.ButtonBack),
		},
		Mode: pxginput.Any,
	}
