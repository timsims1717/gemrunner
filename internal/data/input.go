...
var (
	P1Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"digLeft":   pxginput.NewWithButtons(pixelgl.KeyKP7, pixelgl.ButtonLeftBumper).AddAxis(pixelgl.AxisLeftTrigger, true),
			"digRight":  pxginput.NewWithButtons(pixelgl.KeyKP9, pixelgl.ButtonRightBumper).AddAxis(pixelgl.AxisRightTrigger, true),
	...
	P2Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"pickUp":   pxginput.NewWithButtons(pixelgl.KeyLeftShift, pixelgl.ButtonB),
			"action":   pxginput.NewWithButtons(pixelgl.KeySpace, pixelgl.ButtonA),
			"bomb":     pxginput.NewWithButtons(pixelgl.KeyC, pixelgl.ButtonY),
	...
	P3Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"pickUp":   pxginput.NewWithButtons(pixelgl.KeyB, pixelgl.ButtonB),
			"action":   pxginput.NewWithButtons(pixelgl.KeyV, pixelgl.ButtonA),
			"bomb":     pxginput.NewWithButtons(pixelgl.KeyM, pixelgl.ButtonY),
	...
	P4Input = &pxginput.Input{
		...
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"pickUp":   pxginput.NewWithButtons(pixelgl.KeyComma, pixelgl.ButtonB),
			"action":   pxginput.NewWithButtons(pixelgl.KeyRightAlt, pixelgl.ButtonA),
			"bomb":     pxginput.NewWithButtons(pixelgl.KeyRightControl, pixelgl.ButtonY),
	...
	MenuInput = &pxginput.Input{
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"enter":          pxginput.NewJoyless(pixelgl.KeyEnter).AddButton(pixelgl.ButtonA),
	...
	DebugInput = &pxginput.Input{
		Buttons: map[string]*pxginput.ButtonSet{
			...
			"camUp":           pxginput.NewJoyless(pixelgl.KeyO),
			"camRight":        pxginput.NewJoyless(pixelgl.KeySemicolon),
			"camDown":         pxginput.NewJoyless(pixelgl.KeyL),
			"camLeft":         pxginput.NewJoyless(pixelgl.KeyK),
			"debugLevelUp":    pxginput.NewJoyless(pixelgl.KeyUp),
			"debugLevelDown":  pxginput.NewJoyless(pixelgl.KeyDown),
			"debugLevelLeft":  pxginput.NewJoyless(pixelgl.KeyLeft),
			"debugLevelRight": pxginput.NewJoyless(pixelgl.KeyRight),
			"ctrl":            pxginput.NewJoyless(pixelgl.KeyLeftControl),
		},
		Mode: pxginput.KeyboardMouse,
	}
